...
Rails.application.config.sorcery.submodules = [:http_basic_auth, :external]
...
Rails.application.config.sorcery.configure do |config|
  ...
  config.facebook.callback_url = "http://hungrybrains.ru/oauth/callback?provider=facebook"
  config.facebook.user_info_mapping = {:email => "email", :password => "id"}
